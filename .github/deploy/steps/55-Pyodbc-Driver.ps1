...
$odbcSource = "https://packages.microsoft.com/ubuntu/20.04/prod/pool/main/m/msodbcsql18/msodbcsql18_18.3.2.1-1_amd64.deb"
$odbcSaveLocation = "$PSScriptRoot/../drivers/msodbcsql18_18.3.2.1-1_amd64.deb"
