...
class CosmosTestsAAD(unittest.TestCase):
    _cm: CosmosDb
    _tc: Configurator
    ...
    def setUpClass(cls):
        ...
        cls._cm = CosmosDb(
            ...
            client_id=dbutils.secrets.get("secrets", "Captain--ClientId"),
            client_secret=dbutils.secrets.get("secrets", "Captain--ClientSecret"),
            tenant_id=dbutils.secrets.get("secrets", "Captain--TenantId"),
            database=f"SpetlrCosmosContainer{uuid.uuid4().hex}",
            subscription_id=dbutils.secrets.get("secrets", "Cosmos--Subscriptionid"),
            resource_group=dbutils.secrets.get("secrets", "Cosmos--Resourcegroup"),
            account_name=dbutils.secrets.get("secrets", "Cosmos--Accountname"),
            catalog_name=None,
        )
    ...
    def tearDownClass(cls):
        ...
        cls._cm.delete_database(cls._cm.database)
