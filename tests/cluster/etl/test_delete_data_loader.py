...
class DeleteDataLoaderSqlTests(DataframeTestCase):
    target_id = "DeleteDataLoaderDummy"
    ...
    target_dh_dummy: SqlHandle = None
    ...
    def setUpClass(cls) -> None:
        ...
        cls.sql_server_mock = create_autospec(SqlBaseServer)
        cls.target_dh_dummy = SqlHandle(
